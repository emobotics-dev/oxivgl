...
//!
//! Note: Chinese day names render correctly on host (SDL2) but not on
//! ESP32 due to an LVGL btnmatrix limitation — the btnmatrix widget
//! ignores `Part::Items` font styles on embedded targets, falling back
//! to the default font which lacks CJK glyphs.
